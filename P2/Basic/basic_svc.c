...
main (int argc, char **argv)
{
	...
	pmap_unset (CALCULADORA, BASIC_CALC);
	...
	if (!svc_register(transp, CALCULADORA, BASIC_CALC, calculadora_1, IPPROTO_UDP)) {
		fprintf (stderr, "%s", "unable to register (CALCULADORA, BASIC_CALC, udp).");
		exit(1);
	}
	...
	if (!svc_register(transp, CALCULADORA, BASIC_CALC, calculadora_1, IPPROTO_TCP)) {
		fprintf (stderr, "%s", "unable to register (CALCULADORA, BASIC_CALC, tcp).");
		exit(1);
	}
