...
{
	return (suma_1_svc(argp->n1, argp->n2, rqstp));
}

static calc_res *
_producto_1 (producto_1_argument *argp, struct svc_req *rqstp)
{
	return (producto_1_svc(argp->n1, argp->n2, rqstp));
}
...
{
	return (division_1_svc(argp->n1, argp->n2, rqstp));
}

static calc_res *
_raiz_1 (raiz_1_argument *argp, struct svc_req *rqstp)
{
	return (raiz_1_svc(argp->n1, argp->n2, rqstp));
}

static calc_res *
_potencia_1 (potencia_1_argument *argp, struct svc_req *rqstp)
{
	return (potencia_1_svc(argp->n1, argp->n2, rqstp));
}
...
main (int argc, char **argv)
{
	...
	pmap_unset (CALCULADORA, BASIC_CALC2);
	...
	if (!svc_register(transp, CALCULADORA, BASIC_CALC2, calculadora_1, IPPROTO_UDP)) {
		fprintf (stderr, "%s", "unable to register (CALCULADORA, BASIC_CALC2, udp).");
		exit(1);
	}
	...
	if (!svc_register(transp, CALCULADORA, BASIC_CALC2, calculadora_1, IPPROTO_TCP)) {
		fprintf (stderr, "%s", "unable to register (CALCULADORA, BASIC_CALC2, tcp).");
		exit(1);
	}
